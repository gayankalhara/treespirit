...
void RF24Audio::begin(){
  ...
  radio.openWritingPipe(pipes[radioIdentifier]);     // Set up reading and writing pipes. All of the radios write via multicast on the same pipe
...
void TX(){
    ...
    #endif
        radi.openWritingPipe(pipes[radioIdentifier + 1]);              // Set up reading and writing pipes
